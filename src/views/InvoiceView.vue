<template>
  <div v-if="currentInvoice" class="container invoice-view">
    <router-link class="nav-link flex" :to="{ name: 'HomeView' }">
    ...
    <div class="invoice-details flex flex-column">
      ...
      <div class="bottom flex flex-column">
        <div class="billing-items">
          ...
          <div
            class="item flex"
            v-for="item in currentInvoice.invoiceItemList"
            :key="item"
          >
            <p>{{ item.itemName }}</p>
            <p>{{ item.qty }}</p>
...
export default {
  ...
  computed: {
    ...mapState(["currentInvoiceArray", "editInvoice", "modalActive"]),
  },
