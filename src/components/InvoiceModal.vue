    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="save flex">
        ...
        <div class="right flex">
          ...
          <button class="purple" v-if="editInvoice" type="submit">
            Update Invoice
          </button>
        </div>
      </div>
...
export default {
  name: "invoiceModal",
  components: { Loading, ModalComponent },
  data() {
    return {
      loading: false,
      docId: null,
  ...
  methods: {
    ...
    async uploadInvoice() {
      ...
      const dataBase = addDoc(collection(db, "invoices"), {
        invoiceId: uid(6),
  ...
  computed: {
    ...mapState(["modalActive", "editInvoice", "currentInvoiceArray"]),
  },
};
</script>
